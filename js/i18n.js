...
const translations = {
  tr: {
    ...
    aiPromptDesc: 'Tam prompt ile sadece analizden çıkan ham veri metni arasında geçiş yapın. Çıktı sayfa diliyle birlikte otomatik güncellenir.',
  ...
  en: {
    ...
    aiPromptDesc: 'Switch between the full prompt and the raw analysis text. The output updates automatically in the current page language.',
