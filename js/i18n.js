...
const translations = {
  tr: {
    ...
    heroDesc: 'Yedek dosyanızı yükleyin, görsel dashboard ile kullanım alışkanlıklarınızı analiz edin ve yapay zekadan kişiselleştirilmiş verimlilik önerileri alın.',
    ...
    vpAIDesc: 'Binlerce satırlık yedeğinizi AI\'ın anlayacağı özlü bir prompt\'a dönüştürün. Kişiselleştirilmiş verimlilik önerileri alın.',
    vpPrivacy: '%100 Gizlilik',
    vpPrivacyDesc: 'Verileriniz tarayıcınızdan asla çıkmaz. Sunucu yok, kayıt yok, çerez yok. Tamamen açık kaynak.',
    ...
    feat4Desc: 'AI\'dan alışkanlıklarınızı analiz etmesini, etiket ve listelerinizi yeniden düzenlemesini ve size özel bir aksiyon planı oluşturmasını isteyen yapılandırılmış bir prompt alın.',
    ...
    aiPromptDesc: 'Aşağıdaki seçenekleri kullanımınıza göre ayarlayın. Prompt sayfa diliyle birlikte otomatik güncellenir.',
    ...
    promptCtxOptimizeStructure: 'Liste ve etiket yapısı',
    ...
    pasteGuidance: 'Bu prompt\'u kopyalayıp doğrudan yapıştırın:',
    ...
    faq2A: 'Evet. TickTick Insights tamamen tarayıcınızda çalışır. Hiçbir veri yüklenmez, saklanmaz veya izlenmez. Kaynak kodu tamamen açıktır.',
    ...
    faq4A: 'Binlerce satırlık CSV yedeğiniz, AI\'ın anlayacağı 5-15 KB\'lık özlü bir rapora dönüştürülür. Bu rapor davranış analizi, etiket değerlendirmesi, liste reorganizasyonu, öncelik kullanımı ve aksiyon planı talep eder.',
    ...
    seoParagraph2: 'AI Verimlilik Koçu özelliği, binlerce görevinizi Claude, ChatGPT veya Gemini gibi AI araçlarına yapıştırabileceğiniz yapılandırılmış bir prompt\'a dönüştürür. AI sizin için davranış analizi yapar, etiketlerinizi ve listelerinizi yeniden düzenlemenizi önerir ve somut bir aksiyon planı oluşturur. Tüm işlemler tarayıcınızda gerçekleşir — verileriniz hiçbir sunucuya gönderilmez.',
    // Motivation
  ...
  en: {
    ...
    heroDesc: 'Upload your backup file, analyze your habits with a visual dashboard, and get personalized productivity recommendations from AI.',
    ...
    vpAIDesc: 'Transform thousands of lines of backup data into a concise AI-ready prompt. Get personalized productivity recommendations.',
    vpPrivacy: '100% Privacy',
    vpPrivacyDesc: 'Your data never leaves your browser. No server, no tracking, no cookies. Fully open source.',
    ...
    feat4Desc: 'Get a structured prompt that asks AI to analyze your habits, reorganize your tags and lists, and build a personalized action plan — all from your real data.',
    ...
    aiPromptDesc: 'Adjust the options below to match how you use TickTick. The prompt updates automatically in the current page language.',
    ...
    promptCtxOptimizeStructure: 'List and tag structure',
    ...
    pasteGuidance: 'Copy and paste this prompt directly into:',
    ...
    faq2A: 'Yes. TickTick Insights runs entirely in your browser. No data is uploaded, stored, or tracked. The source code is fully open.',
    ...
    faq4A: 'Your thousands of lines of CSV backup are condensed into a 5-15 KB structured report that AI can understand. This report requests behavioral analysis, tag assessment, list reorganization, priority usage review, and a concrete action plan.',
    ...
    seoParagraph2: 'The AI Productivity Coach feature converts thousands of tasks into a structured prompt you can paste into Claude, ChatGPT, or Gemini. The AI performs behavioral analysis, suggests reorganizing your tags and lists, and creates a concrete action plan. Everything runs in your browser — your data is never sent to any server.',
    // Motivation
