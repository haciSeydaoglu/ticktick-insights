...
const translations = {
  tr: {
    ...
    promptCtxCustomPriority: 'Öncelikleri custom filtrelerle iş akışı olarak kullanıyorum: Yüksek=Sprint, Orta=Next, Düşük=Backlog, Yok=Triage',
  ...
  en: {
    ...
    promptCtxCustomPriority: 'I use priorities with custom filters as a workflow: High=Sprint, Medium=Next, Low=Backlog, None=Triage',
