...
const translations = {
  tr: {
    ...
    promptCtxCustomPriority: 'Öncelikleri şu şekilde kullanıyorum: Yüksek=Sprint, Orta=Next, Düşük=Backlog, Yok=Triage',
  ...
  en: {
    ...
    promptCtxCustomPriority: 'I use priorities as: High=Sprint, Medium=Next, Low=Backlog, None=Triage',
